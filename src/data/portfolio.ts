  ...
  projects: [
    {
      ...
      solution:
        "Developed scalable, TypeScript-based Next.js application with dynamic routing, reusable components, and smart product filtering.",
      tech: ["Next.js", "TypeScript", "Tailwind CSS", "shadcn/ui"],
      liveLink: "https://shapora-store.vercel.app/",
      githubLink: "https://github.com/MMfrontend-developer/Shapora-Store",
      outcome:
        "Seamless user experience across devices with optimized performance and modular architecture for future backend integration.",
    },
    {
      title: "BBR_Agency",
      ...
      problem:
        "Simulate a secure freelance/agency platform for client-service provider collaboration.",
      solution:
        "Built React-based interface with escrow system, testimonial module, and contact system.",
    ...
    title: "Royal_Haven_Hotel_Suites",
      ...
      problem:
        "Create a premium online presence for a boutique hotel with a seamless booking-focused user experience.",
      solution:
        "Developed a mobile-first hotel website with elegant UI, responsive layouts, interactive sections, and optimized performance using Next.js 15.",
      tech: [
        "Next.js 15",
        "TypeScript",
        "Tailwind CSS",
      ...
      liveLink: "https://royal-haven-hotel-suites.vercel.app/",
      githubLink:
        "https://github.com/MMfrontend-developer/Royal-Haven-Hotel-Suites",
      outcome:
        "Delivered a modern, responsive, and visually appealing hotel platform that enhances brand presence and improves guest engagement across devices.",
    },
    {
      title: "OxBank",
      ...
      image: "/Oxbank.png",
      problem:
        "Create a professional fintech interface showcasing dashboards and transaction flows.",
      solution:
        "Developed modular, theme switcher, reusable UI components with authentication-ready flows.",
      tech: ["React", "JavaScript", "CSS3"],
      liveLink: "https://oxbank-oll1.vercel.app/",
      githubLink: "https://github.com/MMfrontend-developer/OX-BANK",
      outcome:
        "Optimized for desktop, tablet, and mobile with emphasis on clarity and accessibility.",
    },
    {
      ...
      solution:
        "Integrated OpenWeatherMap API with geolocation support, autocomplete search, and responsive UI.",
      ...
      outcome:
        "Fast, mobile-friendly, and interactive weather experience with theme switcher and animations",
    },
    {
      ...
      solution:
        "A fully responsive clone of the Kolomoni banking dashboard built with HTML5, CSS3, and JavaScript.",
      tech: ["HTML5", "CSS3", "JavaScript"],
      liveLink: "https://my-project-rouge-eight-17.vercel.app/",
      githubLink: "https://github.com/MMfrontend-developer/my-project",
      outcome:
        "Replicating the UI, user flows, and transaction features accurately.",
    },
    // {
    //   title: "Scientific Calculator",
    //   description:
    //     "A scientific calculator built with HTML5, CSS3, and JavaScript.",
    //   image: "/calculator.png",
    //   problem: "Built complex scientific calculator UI and functionality.",
    //   solution:
    //     "A fully responsive clone of the scientific calculator with theme switcher and real-time clock, built with HTML5, CSS3, and JavaScript.",
    //   tech: ["HTML5", "CSS3", "JavaScript"],
    //   liveLink: "https://my-calculator-theta-murex.vercel.app/",
    //   githubLink: "https://github.com/MMfrontend-developer/My-Calculator",
    //   outcome:
    //     "A fully responsive scientific calculator with theme switcher and real-time clock.",
    // },
  ] as Project[],
};
